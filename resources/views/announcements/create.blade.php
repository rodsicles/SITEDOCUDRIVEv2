            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="form-group flex items-end pb-2">
                    <label class="flex items-center gap-3 cursor-pointer select-none">
                        ...
                        <input type="checkbox" name="is_pinned" value="1" class="w-5 h-5 rounded border-gray-300 dark:border-gray-600 text-[#028a0f] focus:ring-[#028a0f]" {{ old('is_pinned') ? 'checked' : '' }}>
