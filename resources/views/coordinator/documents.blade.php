...
@section('content')
    ...
    <div class="content-card">
        ...
        <div class="documents-filter space-y-4">
            <form action="{{ route('coordinator.documents') }}" method="GET" class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-3">
                ...
                <div class="flex items-end gap-2 md:col-span-2">
                    ...
                    <a href="{{ route('coordinator.documents', array_filter(['folder' => $folderFilter, 'tab' => $tab])) }}" class="btn bg-gray-200 dark:bg-gray-700 text-gray-700 dark:text-gray-300 text-sm">
            ...
            <div class="flex flex-col gap-3 border-t border-gray-200 dark:border-gray-700 pt-4">
                ...
                <div class="flex flex-wrap gap-2">
                    ...
                    <div class="flex items-center gap-2 border border-gray-200 dark:border-gray-700 px-3 py-2 bg-gray-50 dark:bg-[#1e1e1e]">
                        <a href="{{ route('coordinator.documents', array_merge($savedFilter->toQueryParams(), ['saved_filter' => $savedFilter->document_filter_id])) }}" class="text-sm font-medium text-gray-700 dark:text-gray-200 no-underline">
                            {{ $savedFilter->name }}
                        </a>
                    ...
                    <td>
                        <div class="doc-action-btns">
                            <button type="button"
                                ...
                                data-preview-url="{{ route('coordinator.view-document', $document->document_id) }}"
