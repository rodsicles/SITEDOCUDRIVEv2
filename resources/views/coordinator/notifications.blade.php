            ...
            <tbody>
                ...
                <tr class="{{ $rowClasses }}"
                    @if(!$notification->is_read)
                        ...
                        data-mark-url="{{ route('coordinator.notifications.read-json', $notification->notification_id) }}"
                        data-tone="{{ $tone }}"
                    ...
                    <td>
                        @if(!$notification->is_read)
                        <form action="{{ route('coordinator.mark-notification-read', $notification->notification_id) }}" method="POST" onclick="event.stopPropagation();">
                            @csrf
