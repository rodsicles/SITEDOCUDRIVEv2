...
@section('title', 'Teaching Guides - Coordinator')
...
@section('content')
    ...
    <div class="content-card mb-5">
        ...
        <form action="{{ route('coordinator.teaching-guides.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
    ...
    <div class="content-card">
        ...
        <div class="documents-filter flex items-center gap-4 flex-wrap">
            <form action="{{ route('coordinator.teaching-guides.index') }}" method="GET" class="flex items-center gap-2 ml-auto">
                ...
                <tr>
                    ...
                    <td>
                        <div class="doc-action-btns">
                            ...
                            <form action="{{ route('coordinator.teaching-guides.destroy', $guide->id) }}" method="POST" onsubmit="return confirm('Delete this guide?')">
                                @csrf @method('DELETE')
