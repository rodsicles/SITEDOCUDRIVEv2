                ...
                <tr>
                    ...
                    <td>
                        <div class="doc-action-btns">
                            <a href="{{ route('dean.exam-questionnaires.view', $q->id) }}" target="_blank" class="btn btn-primary text-xs">
                                <i class="fas fa-eye"></i> View
                            </a>
                            <a href="{{ route('dean.exam-questionnaires.download', $q->id) }}" class="btn btn-success text-xs">
