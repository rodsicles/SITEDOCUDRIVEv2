<form action="{{ route('documents.open-tg-subject') }}" method="POST" class="semester-subject-open-form mb-4 p-4 border border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-900/40">
    @csrf
